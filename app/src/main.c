...
#define POINTS 5        //Numero di punti inseriti
...
int main(void)
{
    ...
    /*
    double points_elem[3*POINTS] = {    +0.0,   +0.4,   +0.4,   -0.1,   -0.4,
                                        +0.0,   +0.0,   +0.2,   +0.4,   +0.4,
                                        -0.8,   -0.7,   -0.6,   -0.7,   -0.7};
    */
    /*
    double points_elem[3*POINTS] = {    -0.4,   +0.4,
                                        +0.0,   +0.0,
                                        -0.7,   -0.7};
    */
    /*
    ...
    */
    ...
    circular_path(0.4, -0.7, 1.0, 500, &pos, &vel, &acc);
